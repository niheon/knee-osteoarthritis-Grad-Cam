...
icon = Image.open("app/img/logo_knee.jpg")
st.set_page_config(
...
model = tf.keras.models.load_model("app\model_Xception_ft.hdf5")
target_size = (224, 224)
...
with st.sidebar:
    st.image(icon)
    st.subheader("Continuous work for Niheon-AniVision")
    st.caption("**Niheon Nelson**")
...
# Body
st.header("knee-osteoarthritis with Grad-Cam")
